...
static class Scenarios {
    public static IReadOnlyList<AuditScenario> All { get; } = [
        ...
        ], RequireRadioIds: ["pilot-check-in"]),
        new("rapier-radio-gear-up", "Rapier — checklist stays off-air; wait for tactical check-in", 10, [
            Sample("spawn"),
            WaitUntilRadio("pilot-check-in", timeoutSeconds: 90),
            Sample("check-in"),
            Wait(3), Sample("after-check-in"),
        ], RequireRadioIds: ["pilot-check-in"]),
        new("rapier-commit", "Rapier airborne intercept — COMMIT + CONTROL", 10, [
            ...
            WaitUntilRadio("control-commit-short", timeoutSeconds: 20),
            Sample("commit"),
            Wait(4), Sample("commit+4s"),
        ], BeatFactory: AirborneInterceptCard,
            RequireRadioIds: ["control-commit-short", "pilot-commit-ack"]),
        new("rapier-guns", "Rapier Intercept — trigger stays off-air", 10, [
            Sample("spawn"),
        ...
        ], RequireRadioIds: ["pilot-initial"]),
        new("rapier-circuits-land", "Circuits — landing clearance and callsign acknowledgment", 11, [
            Sample("spawn"),
            WaitUntilLeg("BASE", timeoutSeconds: 240),
            WaitUntilRadio("tower-cleared-arrested-landing", timeoutSeconds: 30),
            Sample("cleared"),
            WaitUntilRadio("pilot-landing-ack", timeoutSeconds: 30),
            Sample("ack"),
        ], RequireRadioIds: [
            "tower-cleared-arrested-landing", "pilot-landing-ack"]),
