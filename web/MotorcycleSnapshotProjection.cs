...
internal static class MotorcycleSnapshotProjection
{
    ...
    static object BuildState(WeekendRideMissionRuntime runtime, MotorcycleControlMode controlMode)
    {
        ...
        return new {
            ...
            circuit_progress_m = snap.CircuitProgressM,
            circuit_length_m = snap.CircuitLengthM,
            last_sector = snap.LastSectorIndex,
            next_sector = snap.NextSectorIndex,
            golden_path_kind = snap.GoldenPathKind,
            golden_path_token = snap.GoldenPathToken,
            on_open_road = snap.IsOnOpenRoad,
            open_road_distance_m = snap.OpenRoadDistanceM,
