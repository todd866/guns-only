...
} from "../render/cobra/cobra_canyon_plan.js?v=341";
import { createCobraCanyonPresentation } from "../render/cobra/cobra_canyon_presentation.js?v=341";
import { resolveCobraVietnamFoliageTextures } from "../render/cobra/cobra_canyon_foliage.js?v=341";
import {
  COBRA_CANYON_TOUR_BASE_AGL_M,
  createCobraCanyonRouteSampler,
  sampleCobraCanyonTour,
} from "../render/cobra/cobra_canyon_tour.js?v=341";
import { createCobraGroundWarPresentation } from "../render/cobra/cobra_ground_war.js?v=341";
import {
  cobraGoldenPathState,
  createCobraGoldenPath,
} from "../render/cobra/cobra_golden_path.js?v=341";
import { createHud } from "../hud.js?v=341";
import {
  cobraHudState,
  createCobraHudFrame,
} from "../render/cobra/cobra_hud_adapter.js?v=341";
import {
  cobraRotorcraftHudModel,
  drawCobraRotorcraftHud,
  formatAviationAgl,
  formatAviationRange,
} from "../render/cobra/cobra_rotorcraft_hud.js?v=341";
import { cobraObjectiveCopy } from "../render/cobra/cobra_objective_copy.js?v=341";
import {
  cobraTacticalMapBounds,
  cobraTacticalMapModel,
} from "../render/cobra/cobra_tactical_map.js?v=341";
import {
  COBRA_MAP_CAPTION_PX,
  drawCobraTacticalMap,
} from "../render/cobra/cobra_tactical_map_draw.js?v=341";
import { bakeCobraTacticalRelief } from "../render/cobra/cobra_tactical_map_relief.js?v=341";
import {
  emberActObjectiveOverlay,
  emberActRemainingM,
  emberPathGuidanceState,
} from "../render/cobra/cobra_ember_path.js?v=341";
import { createGuidancePath } from "../render/scene/guidance_path.js?v=341";
import {
  updateFlightAudio,
...
} from "../render/cobra/cobra_control_profile.js?v=341";
import {
...
} from "../render/cobra/cobra_pilot_input.js?v=341";
import {
  createCobraSortieReadyInterlock,
  hasDeliberateCobraCockpitInput,
} from "../render/cobra/cobra_sortie_ready.js?v=341";
import {
  COBRA_TURNAROUND_ACTION_CODE,
  cobraTurnaroundActionHeld,
  cobraTurnaroundIsActive,
  cobraTurnaroundLocksFlightControls,
} from "../render/cobra/cobra_turnaround.js?v=341";
import {
  createAh1gPresence,
  eyeWorldFromVehicle,
  updateAh1gPresence,
} from "../render/cobra/ah1g_presence.js?v=341";
import {
...
} from "../render/cobra/cobra_camera_bias.js?v=341";
import {
  cobraMissionStatusCopy,
  cobraTerminalCauseCopy,
} from "../render/cobra/cobra_terminal_causes.js?v=341";
import { loadCobraVietnamPalmGeometry } from "../render/cobra/cobra_canyon_foliage_models.js?v=341";
import {
  createParkedCobra,
  placeParkedCobra,
} from "../render/cobra/cobra_parked_airframe.js?v=341";
import {
  cobraFormationRadio,
  cobraFormationLeadPose,
  createCobraFormationLead,
} from "../render/cobra/cobra_formation_lead.js?v=341";
import {
  applyTexelStabilizedDirectionalShadow,
} from "../render/visual/shadow_stabilizer.js?v=341";
import { createCobraTelemetryChannel } from "../render/cobra/cobra_telemetry.js?v=341";
import {
  MAIN_MENU_HREF,
  resolveEscapeAction,
} from "../render/cobra/cobra_mission_exit.js?v=341";
import { createControlsOnboarding } from "../render/onboarding/first_run_controls.js?v=341";
import { COBRA_ONBOARDING_CONTENT } from "../render/onboarding/controls_content.js?v=341";
...
import { COBRA_CANYON_VISUAL_PROFILE } from "../render/cobra/cobra_canyon_visual_profile.js?v=341";
