...
} from "./render/debrief/sortie_result.js?v=365";
import {
...
} from "./render/onboarding/first_run_valley.js?v=365";
import {
  dialogTabDestination,
  renderedDialogControl,
} from "./render/onboarding/modal_focus.js?v=365";
...
import {
  ...
  normalizeBuildInfo,
  runningBuildInfoUrl,
} from "./render/release/release_identity.js?v=365";
import { experienceAccess } from "./render/release/quarantine_gate.js?v=365";
import {
...
import { recoveryNavigationPresentation } from "./render/hud/limits_panel.js?v=365";
import {
  meshNavPresentation,
...
} from "./render/nav/carrier_sortie_route_presentation.js?v=365";
import {
  syncCarrierSortieTouchRtbControl,
} from "./render/nav/carrier_sortie_touch_control.js?v=365";
...
import {
  ...
  AI_COMPUTE_LEVEL,
} from "./render/telemetry/ai_frame_pressure.js?v=365";
import {
...
} from "./render/telemetry/telemetry_batch.js?v=365";
import { createShellHealthBeacon } from "./render/telemetry/shell_health.js?v=365";
import { detectEmbeddedBrowser } from "./render/shell/inapp_browser.js?v=365";
import { standaloneNavigationHref } from "./render/shell/standalone_navigation.js?v=365";
import {
  createBootWatchdog,
  resourceProgressCounter,
} from "./render/shell/boot_watchdog.js?v=365";
import { bootFallbackModel, mountBootFallback } from "./render/shell/boot_fallback.js?v=365";
import {
  CONTROL_BINDINGS,
  controlCodeLabel,
...
} from "./render/scene/scene_builders.js?v=365";
import { createHighAltitudeBalloon } from "./render/scene/high_altitude_balloon.js?v=365";
import {
...
if ("serviceWorker" in navigator) {
  window.addEventListener("load", () => {
    navigator.serviceWorker.register("service-worker.js?v=365")
