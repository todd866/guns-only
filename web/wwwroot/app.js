...
} from "./render/debrief/sortie_result.js?v=360";
import {
...
} from "./render/onboarding/first_run_valley.js?v=360";
import {
  dialogTabDestination,
  renderedDialogControl,
} from "./render/onboarding/modal_focus.js?v=360";
...
import {
  ...
  normalizeBuildInfo,
  runningBuildInfoUrl,
} from "./render/release/release_identity.js?v=360";
import { experienceAccess } from "./render/release/quarantine_gate.js?v=360";
import {
...
import { recoveryNavigationPresentation } from "./render/hud/limits_panel.js?v=360";
import {
  meshNavPresentation,
...
} from "./render/nav/carrier_sortie_touch_control.js?v=360";
...
import {
  ...
  AI_COMPUTE_LEVEL,
} from "./render/telemetry/ai_frame_pressure.js?v=360";
import {
...
} from "./render/telemetry/telemetry_batch.js?v=360";
import { createShellHealthBeacon } from "./render/telemetry/shell_health.js?v=360";
import { detectEmbeddedBrowser } from "./render/shell/inapp_browser.js?v=360";
import { standaloneNavigationHref } from "./render/shell/standalone_navigation.js?v=360";
import {
  createBootWatchdog,
  resourceProgressCounter,
} from "./render/shell/boot_watchdog.js?v=360";
import { bootFallbackModel, mountBootFallback } from "./render/shell/boot_fallback.js?v=360";
import {
  CONTROL_BINDINGS,
  controlCodeLabel,
...
} from "./render/scene/scene_builders.js?v=360";
import { createHighAltitudeBalloon } from "./render/scene/high_altitude_balloon.js?v=360";
import {
...
if ("serviceWorker" in navigator) {
  window.addEventListener("load", () => {
    navigator.serviceWorker.register("service-worker.js?v=360")
