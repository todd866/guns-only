...
} from "./render/debrief/sortie_result.js?v=364";
import {
...
} from "./render/onboarding/first_run_valley.js?v=364";
import {
  dialogTabDestination,
  renderedDialogControl,
} from "./render/onboarding/modal_focus.js?v=364";
...
import {
  ...
  normalizeBuildInfo,
  runningBuildInfoUrl,
} from "./render/release/release_identity.js?v=364";
import { experienceAccess } from "./render/release/quarantine_gate.js?v=364";
import {
...
import { recoveryNavigationPresentation } from "./render/hud/limits_panel.js?v=364";
import {
  meshNavPresentation,
...
} from "./render/nav/carrier_sortie_touch_control.js?v=364";
...
import {
  ...
  AI_COMPUTE_LEVEL,
} from "./render/telemetry/ai_frame_pressure.js?v=364";
import {
...
} from "./render/telemetry/telemetry_batch.js?v=364";
import { createShellHealthBeacon } from "./render/telemetry/shell_health.js?v=364";
import { detectEmbeddedBrowser } from "./render/shell/inapp_browser.js?v=364";
import { standaloneNavigationHref } from "./render/shell/standalone_navigation.js?v=364";
import {
  createBootWatchdog,
  resourceProgressCounter,
} from "./render/shell/boot_watchdog.js?v=364";
import { bootFallbackModel, mountBootFallback } from "./render/shell/boot_fallback.js?v=364";
import {
  CONTROL_BINDINGS,
  controlCodeLabel,
...
} from "./render/scene/scene_builders.js?v=364";
import { createHighAltitudeBalloon } from "./render/scene/high_altitude_balloon.js?v=364";
import {
...
if ("serviceWorker" in navigator) {
  window.addEventListener("load", () => {
    navigator.serviceWorker.register("service-worker.js?v=364")
