...
import { createHud } from "./hud.js?v=241";
import {
...
import {
  ...
  sortieResultCopy,
} from "./render/debrief/sortie_result.js?v=241";
...
import {
  ...
  normalizeBuildInfo,
  runningBuildInfoUrl,
} from "./render/release/release_identity.js?v=241";
import { experienceAccess } from "./render/release/quarantine_gate.js?v=241";
import {
...
import { recoveryNavigationPresentation } from "./render/hud/limits_panel.js?v=241";
import {
  meshNavPresentation,
...
import {
  ...
  AI_COMPUTE_LEVEL,
} from "./render/telemetry/ai_frame_pressure.js?v=241";
import {
...
} from "./render/telemetry/telemetry_batch.js?v=241";
import {
  CONTROL_BINDINGS,
  controlCodeLabel,
  ...
  savePlayerSettings,
} from "./render/settings/player_settings.js?v=241";
import {
  AUTHORITY_TICK_HZ,
...
} from "./render/scene/scene_builders.js?v=241";
import { createHighAltitudeBalloon } from "./render/scene/high_altitude_balloon.js?v=241";
import {
  setFlightAudioEnabled,
  suspendFlightAudio,
  updateFlightAudio,
} from "./render/audio/flight_audio.js?v=241";
import {
  primeCasevacAudio,
...
if ("serviceWorker" in navigator) {
  window.addEventListener("load", () => {
    navigator.serviceWorker.register("service-worker.js?v=241")
