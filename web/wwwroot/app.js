...
import { createHud } from "./hud.js?v=177";
import {
...
import {
  ...
  sortieResultCopy,
} from "./render/debrief/sortie_result.js?v=177";
...
import {
  ...
  normalizeBuildInfo,
  runningBuildInfoUrl,
} from "./render/release/release_identity.js?v=177";
import {
...
import { recoveryNavigationPresentation } from "./render/hud/limits_panel.js?v=177";
import {
  applyLookDelta,
  trackpadLookDelta,
...
import {
  ...
  AI_COMPUTE_LEVEL,
} from "./render/telemetry/ai_frame_pressure.js?v=177";
...
} from "./render/telemetry/telemetry_batch.js?v=177";
import {
  CONTROL_BINDINGS,
  controlCodeLabel,
  ...
  savePlayerSettings,
} from "./render/settings/player_settings.js?v=177";
import {
  AUTHORITY_TICK_HZ,
...
} from "./render/scene/scene_builders.js?v=177";
import {
  setFlightAudioEnabled,
  updateFlightAudio,
} from "./render/audio/flight_audio.js?v=177";
import {
  primeCasevacAudio,
