...
import {
  ...
  sortieResultCopy,
} from "./render/debrief/sortie_result.js?v=320";
import {
...
import {
  ...
  normalizeBuildInfo,
  runningBuildInfoUrl,
} from "./render/release/release_identity.js?v=320";
import { experienceAccess } from "./render/release/quarantine_gate.js?v=320";
import {
...
import { recoveryNavigationPresentation } from "./render/hud/limits_panel.js?v=320";
import {
  meshNavPresentation,
...
} from "./render/nav/carrier_sortie_route_presentation.js?v=320";
import {
  syncCarrierSortieTouchRtbControl,
} from "./render/nav/carrier_sortie_touch_control.js?v=320";
...
import {
  ...
  AI_COMPUTE_LEVEL,
} from "./render/telemetry/ai_frame_pressure.js?v=320";
import {
...
} from "./render/telemetry/telemetry_batch.js?v=320";
import { createShellHealthBeacon } from "./render/telemetry/shell_health.js?v=320";
import { detectEmbeddedBrowser } from "./render/shell/inapp_browser.js?v=320";
import {
  createBootWatchdog,
  resourceProgressCounter,
} from "./render/shell/boot_watchdog.js?v=320";
import { bootFallbackModel, mountBootFallback } from "./render/shell/boot_fallback.js?v=320";
import {
  CONTROL_BINDINGS,
  controlCodeLabel,
  ...
  savePlayerSettings,
} from "./render/settings/player_settings.js?v=320";
import {
  AUTHORITY_TICK_HZ,
...
} from "./render/scene/scene_builders.js?v=320";
import { createHighAltitudeBalloon } from "./render/scene/high_altitude_balloon.js?v=320";
import {
...
if ("serviceWorker" in navigator) {
  window.addEventListener("load", () => {
    navigator.serviceWorker.register("service-worker.js?v=320")
