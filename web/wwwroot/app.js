...
import { createHud } from "./hud.js?v=194";
import {
...
import {
  ...
  sortieResultCopy,
} from "./render/debrief/sortie_result.js?v=194";
...
import {
  ...
  normalizeBuildInfo,
  runningBuildInfoUrl,
} from "./render/release/release_identity.js?v=194";
import {
...
import { recoveryNavigationPresentation } from "./render/hud/limits_panel.js?v=194";
import {
  meshNavPresentation,
...
import {
  ...
  AI_COMPUTE_LEVEL,
} from "./render/telemetry/ai_frame_pressure.js?v=194";
...
} from "./render/telemetry/telemetry_batch.js?v=194";
import {
  CONTROL_BINDINGS,
  controlCodeLabel,
  ...
  savePlayerSettings,
} from "./render/settings/player_settings.js?v=194";
import {
  AUTHORITY_TICK_HZ,
...
} from "./render/scene/scene_builders.js?v=194";
import {
  setFlightAudioEnabled,
  updateFlightAudio,
} from "./render/audio/flight_audio.js?v=194";
import {
  primeCasevacAudio,
