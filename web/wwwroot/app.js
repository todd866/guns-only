...
import { createHud } from "./hud.js?v=235";
import {
...
import {
  ...
  sortieResultCopy,
} from "./render/debrief/sortie_result.js?v=235";
...
import {
  ...
  normalizeBuildInfo,
  runningBuildInfoUrl,
} from "./render/release/release_identity.js?v=235";
import {
...
import { recoveryNavigationPresentation } from "./render/hud/limits_panel.js?v=235";
import {
  meshNavPresentation,
...
import {
  ...
  AI_COMPUTE_LEVEL,
} from "./render/telemetry/ai_frame_pressure.js?v=235";
...
} from "./render/telemetry/telemetry_batch.js?v=235";
import {
  CONTROL_BINDINGS,
  controlCodeLabel,
  ...
  savePlayerSettings,
} from "./render/settings/player_settings.js?v=235";
import {
  AUTHORITY_TICK_HZ,
...
} from "./render/scene/scene_builders.js?v=235";
import {
...
if ("serviceWorker" in navigator) {
  window.addEventListener("load", () => {
    navigator.serviceWorker.register("service-worker.js?v=235")
