...
import { createHud } from "./hud.js?v=202";
import {
...
import {
  ...
  sortieResultCopy,
} from "./render/debrief/sortie_result.js?v=202";
...
import {
  ...
  normalizeBuildInfo,
  runningBuildInfoUrl,
} from "./render/release/release_identity.js?v=202";
import {
...
import { recoveryNavigationPresentation } from "./render/hud/limits_panel.js?v=202";
import {
  meshNavPresentation,
...
import {
  ...
  AI_COMPUTE_LEVEL,
} from "./render/telemetry/ai_frame_pressure.js?v=202";
...
} from "./render/telemetry/telemetry_batch.js?v=202";
import {
  CONTROL_BINDINGS,
  controlCodeLabel,
  ...
  savePlayerSettings,
} from "./render/settings/player_settings.js?v=202";
import {
  AUTHORITY_TICK_HZ,
...
} from "./render/scene/scene_builders.js?v=202";
import {
...
if ("serviceWorker" in navigator) {
  window.addEventListener("load", () => {
    navigator.serviceWorker.register("service-worker.js?v=202")
