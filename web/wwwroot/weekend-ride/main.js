...
import { HelmetHud } from "../render/motorcycle/helmet_hud.js?v=331";
import {
  loadRideBest,
  saveRideBest,
} from "../render/ride/ride_best_lap_store.js?v=331";
import {
  dominantSignedAxis,
  gamepadRiderAxes,
} from "../render/motorcycle/rider_input.js?v=331";
import {
  createRapierTrackDayPresentation,
} from "../render/motorcycle/track_day_presentation.js?v=331";
import { viewPitchRad } from "../render/motorcycle/view_attitude.js?v=331";
import {
...
import { WEEKEND_RIDE_ONBOARDING_CONTENT } from "../render/onboarding/controls_content.js?v=331";
