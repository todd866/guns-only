  ...
  const chunks = [
    {
      ...
      rows: [
        ...
        // Engagement-local rounds reset to four after a replacement; the sortie ledger does not.
        { k: "st", q: 1, d: { t: 12.5, rounds_fired: 4, sortie_rounds_fired: 10,
          hits: 2, kill_count: 1,
    ...
    },
    {
      ...
      rows: [
        ...
        // Legacy tape: no sortie_rounds_fired ledger, so admin retains the engagement-local max.
        { k: "st", q: 0, s: { telemetry_sortie_id: "sortie-private-b", t: 0, rounds_fired: 0,
          hits: 0, kill_count: 0, shots_total: 0, shots_in_window: 0, player_alive: true,
          opponent_alive: true, bandit_alive: false, finished: false,
          sortie_outcome: "NONE" } },
        { k: "st", q: 1, d: { t: 8, rounds_fired: 5,
          shots_total: 5, shots_in_window: 1,
