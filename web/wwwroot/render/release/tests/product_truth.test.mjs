...
test("the browser and installed-app descriptions match the two production aircraft", async () => {
...
test("the evergreen status matrix covers the executable experience catalog", async () => {
  ...
  assert.match(status, /Production at start of stabilization: Build 237/);
