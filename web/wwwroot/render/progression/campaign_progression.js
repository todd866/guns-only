...
export const EXPERIENCE_CATALOG = Object.freeze([
  ...
  experience({
    ...
    aircraft: "F-22A",
    title: "Ace Duel",
    shortObjective: "Beat one Ace in a decisive guns-only duel.",
    qualification: "",
    releaseState: EXPERIENCE_RELEASE_STATE.PREVIEW,
    blocker: "A complete human capstone flight is still outstanding.",
  }),
  experience({
    id: "multiplayer",
    mission: 7,
  ...
  experience({
    ...
    shortObjective: "Destroy fortified gun pits, clear and cover each capture, then hold the point majority until hostile tickets reach zero in the AH-1G.",
    qualification: "",
    releaseState: EXPERIENCE_RELEASE_STATE.PRODUCTION,
    visible: true,
    blocker: "",
