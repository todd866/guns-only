...
import { createAirframeFromDefinition } from "./airframe_from_definition.js?v=320";
import {
  addSemanticSocket,
  ...
  makeMaterial,
} from "./airframe_primitives.js?v=320";
import rapierV2Definition from "../../airframes/rapier_v2.embedded.js?v=320";
