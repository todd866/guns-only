...
import { createAirframeFromDefinition } from "./airframe_from_definition.js?v=324";
import {
  addSemanticSocket,
  ...
  makeMaterial,
} from "./airframe_primitives.js?v=324";
import rapierV2Definition from "../../airframes/rapier_v2.embedded.js?v=324";
