...
import { createAirframeFromDefinition } from "./airframe_from_definition.js?v=261";
import {
  addSemanticSocket,
  ...
  makeMaterial,
} from "./airframe_primitives.js?v=261";
import rapierV2Definition from "../../airframes/rapier_v2.embedded.js?v=261";
