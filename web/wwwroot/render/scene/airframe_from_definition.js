...
import {
  ...
  makeMaterial,
} from "./airframe_primitives.js?v=362";
import {
  adaptShapeFirstAirframeDefinition,
  isShapeFirstAirframeDefinition,
} from "./shape_first_airframe_adapter.js?v=362";
import { createShapeFirstWingGeometry } from "./shape_first_wing_geometry.js?v=362";
import {
  createRapierMaterials,
  createRapierInlet,
  createRapierExhaust,
} from "./rapier_airframe_finish.js?v=362";
