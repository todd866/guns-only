...
export const SCENARIOS = [
  ...
  },
  {
    ...
    about: "At exact six, a preferred lift gate can replace the neutral any-plane ring.",
  ...
  },
  {
    ...
    about: "Envelope override held: the lift tick and roll gate remain even though SAS assist is inactive.",
    player: { headingDeg: 45, pitchDeg: 0, bankDeg: 0, altFt: 10000 },
    bandit: { azimuthDeg: 45, elevationDeg: 0, rangeM: 720 },
    lead: null,
    view: { padlock: true, padlockPhase: "TRACK", sensor: "auto" },
    state: {
      range_m: 720, closure_kts: -100, requested_envelope_override: true,
      ...
      padlock_roll_assist_any_plane: false, padlock_roll_error_deg: 90,
    },
  },
  {
    name: "padlock-target-two-roll-right",
    about: "TARGET 2 owns the camera, gun selection, range, and explicit roll-right director while the distant primary remains a quiet awareness contact.",
    player: { headingDeg: 45, pitchDeg: 2, bankDeg: -18, altFt: 10000 },
    bandit: { azimuthDeg: -105, elevationDeg: 8, rangeM: 5400 },
    wingman: { azimuthDeg: 58, elevationDeg: 20, rangeM: 720 },
    lead: null,
    view: {
      padlock: true,
    ...
    state: {
      range_m: 720, closure_kts: 145,
      selected_player_gun_target_slot: 1,
      w1_present: 1, w1_alive: 1,
      padlock_roll_assist_selected: true, padlock_roll_assist_geometry_valid: true,
      padlock_roll_assist_captured: false, padlock_roll_assist_active: false,
      padlock_roll_assist_any_plane: false,
      padlock_roll_error_deg: 66.77167549843873,
    },
  },
  {
    name: "padlock-dead-six-low-prefers-skyward",
    about: "Near six at low radar altitude: the preferred lift plane points skyward rather than drawing a neutral any-plane ring.",
    player: { headingDeg: 45, pitchDeg: 0, bankDeg: 0, altFt: 900 },
    bandit: { azimuthDeg: 180, elevationDeg: 0, rangeM: 720 },
    lead: null,
    view: { padlock: true, padlockPhase: "TRACK", sensor: "auto" },
    state: {
      range_m: 720, closure_kts: -100, radar_alt_ft: 900,
      padlock_roll_assist_selected: true, padlock_roll_assist_geometry_valid: true,
      padlock_roll_assist_captured: false, padlock_roll_assist_active: false,
      padlock_roll_assist_any_plane: false, padlock_roll_error_deg: 0,
      padlock_preferred_plane_valid: true, padlock_preferred_plane_deg: 0,
    },
  },
  {
    name: "padlock-dead-six-slow-prefers-flat",
    about: "Near six, slow versus the corner: the preferred gate is near ±90° rather than a pure vertical pull.",
    player: { headingDeg: 45, pitchDeg: 0, bankDeg: 0, altFt: 10000 },
    bandit: { azimuthDeg: 180, elevationDeg: 0, rangeM: 720 },
    lead: null,
    view: { padlock: true, padlockPhase: "TRACK", sensor: "auto" },
    state: {
      range_m: 720, closure_kts: -100, true_airspeed_kts: 220, corner_speed_kias: 335,
      padlock_roll_assist_selected: true, padlock_roll_assist_geometry_valid: true,
      padlock_roll_assist_captured: false, padlock_roll_assist_active: false,
      padlock_roll_assist_any_plane: false, padlock_roll_error_deg: 90,
      padlock_preferred_plane_valid: true, padlock_preferred_plane_deg: 90,
    },
  },
  {
  ...
  },
  {
    ...
    about: "Manual look nearly straight up: the camera projection is singular, so one release-look instruction replaces competing locator and attitude cues.",
  ...
  {
    name: "forward-target-two-offscreen",
    about: "Tab-selected TARGET 2 remains the sole amber off-screen locator in forward view while the distant primary stays a quiet on-screen awareness contact.",
    player: { headingDeg: 0, pitchDeg: 0, bankDeg: 0, altFt: 8000 },
    bandit: { azimuthDeg: 8, elevationDeg: 3, rangeM: 5400 },
    wingman: { azimuthDeg: 92, elevationDeg: 12, rangeM: 820 },
    lead: null,
    state: {
      range_m: 820, closure_kts: 120,
      selected_player_gun_target_slot: 1,
      w1_present: 1, w1_alive: 1,
    },
  },
  ...
  },
  {
    ...
    about: "Cobra HUD at production heading 90° / 58° FOV: W is optical-centre, the ladder is world-conformal, and a down-right cruise FPV follows ground velocity.",
    player: { headingDeg: 90, pitchDeg: 0, bankDeg: 0, altFt: 400 },
    bandit: { azimuthDeg: 0, elevationDeg: -8, rangeM: 500 },
    lead: null,
    cameraFovDeg: 58,
    ladderReference: "camera",
    view: { lookYawDeg: 0, lookPitchDeg: 0 },
    state: {
      ...
      aoa_deg: 6,
      beta_deg: 4,
      heli_flight_path: true,
      heli_fpv_mode: "cruise",
      indicated_airspeed_kts: 60,
      true_airspeed_kts: 60,
      ground_speed_kts: 55,
      has_afterburner: false,
      has_speed_brake: false,
      fuel_lb: undefined,
  ...
  {
    name: "cobra-forward-pitched",
    about: "Pitched/banked Cobra at production heading 90° / 58° FOV: centred body W must separate from the conformal world-horizon 0 rung.",
    player: { headingDeg: 90, pitchDeg: 20, bankDeg: 35, altFt: 400 },
    bandit: { azimuthDeg: 0, elevationDeg: -8, rangeM: 500 },
    lead: null,
    cameraFovDeg: 58,
    ladderReference: "camera",
  ...
  {
    name: "cobra-hover-heading-east",
    about: "Hover cue at the real heading-90 spawn: forward-east drift draws up and northward drift draws left, never in raw world E/N directions.",
    // Camp Ember is roughly 202 m MSL; keep the mobile readout on the real launch altitude.
    player: { headingDeg: 90, pitchDeg: 0, bankDeg: 0, altFt: 663 },
    bandit: { azimuthDeg: 0, elevationDeg: -8, rangeM: 500 },
    lead: null,
    cameraFovDeg: 58,
    ladderReference: "camera",
    ...
    state: {
      ...
      heli_flight_path: true,
      heli_fpv_mode: "hover",
      heli_hover_right_kt: -4,
      heli_hover_forward_kt: 6,
      indicated_airspeed_kts: 7.2,
      true_airspeed_kts: 7.2,
      ground_speed_kts: 7.2,
      has_afterburner: false,
      has_speed_brake: false,
      fuel_lb: undefined,
    },
  ...
  {
    name: "rapier-mobile-climb-bvr",
    about: "Real-device mobile failure case: phase-2 Rapier climb with a 160 NM BVR contact. The contact waypoint must never become a giant recovery box; the tactical rail owns actual/commanded energy, weapon, fuel, target, and fast time.",
    player: { headingDeg: 270, pitchDeg: 9, bankDeg: 0, altFt: 4236 },
    bandit: { azimuthDeg: 0, elevationDeg: 2, rangeM: 160 * 1852 },
    lead: null,
    state: {
      lead_valid: false,
      gun_solution: false,
      ...
      range_m: 160 * 1852,
      closure_kts: 916,
      calibrated_airspeed_kts: 479,
      indicated_airspeed_kts: 479,
      true_airspeed_kts: 510,
      ground_speed_kts: 492,
      vertical_speed_fpm: 5000,
      mach: 0.77,
      ammo: 480,
      fuel_lb: 3523,
      ...
      rapier_target_mach: 0.90,
      rapier_target_altitude_ft: 56_000,
      rapier_gun_drones_remaining: 4,
      rapier_recovery_gate: 0,
      rapier_guidance_x: 0,
      rapier_guidance_y: 4236 * 0.3048,
      rapier_guidance_z: 160 * 1852,
      recovery_point_known: true,
      rtb_range_nm: 160,
      rtb_bearing_deg: 270,
      rtb_turn_deg: 0,
      rtb_closure_kts: 492,
      rtb_eta_min: 160 / 492 * 60,
      fuel_to_home_estimate_lb: 7200 * (160 / 492),
      fuel_on_arrival_estimate_lb: 3523 - 7200 * (160 / 492),
      fuel_reserve_target_lb: 1000,
      fuel_reserve_margin_lb: 3523 - 7200 * (160 / 492) - 1000,
  ...
  {
    name: "rapier-circuits-downwind-verified",
    about: "Normal downwind: tapes/director own NOW and the world box owns NEXT. Verified gear/elevons and non-limiting fuel must not retain their cards or repeat prose.",
    player: { headingDeg: 180, pitchDeg: 0, bankDeg: 28, altFt: 3130 },
    bandit: { azimuthDeg: 70, elevationDeg: -8, rangeM: 9000 },
    lead: null,
    state: {
      lead_valid: false,
      gun_solution: false,
      ...
      ground_speed_kts: 245,
      indicated_airspeed_kts: 238,
      mach: 0.38,
      fuel_lb: 9860,
      fuel_capacity_lb: 9920,
      fuel_bingo_lb: 1000,
      ...
      rapier_fd_bank_deg: 30,
      rapier_fd_target_ktas: 250,
      rapier_target_altitude_ft: 3130,
      rapier_gate_half_m: 110,
      rapier_gate_face_x: 0,
      rapier_gate_face_y: 0,
      rapier_gate_face_z: 1,
      rapier_gate_in_volume: false,
      rapier_gate_energy_ok: true,
      rapier_guidance_x: 0,
      rapier_guidance_y: 3130 * 0.3048,
      rapier_guidance_z: -6000,
      has_landing_gear: true,
      has_flaps: true,
      gear_handle: "DOWN",
  ...
  {
    name: "rapier-circuits-downwind-config-due",
    about: "Downwind exception: the box and systems card may speak because landing configuration is still clean. Normal fuel and on-speed prose remain suppressed.",
    player: { headingDeg: 180, pitchDeg: 0, bankDeg: 28, altFt: 3130 },
    bandit: { azimuthDeg: 70, elevationDeg: -8, rangeM: 9000 },
    lead: null,
    state: {
