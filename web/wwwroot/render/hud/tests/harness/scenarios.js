...
export const SCENARIOS = [
  ...
  {
    // Cobra gorge forward view: camera-referenced ladder under the rear-seat +0.08 rad
    // (~4.6°) sight bias; W stays body-forward and FPV remains velocity-through-camera.
    name: "cobra-forward-level",
    about: "Cobra HUD at production 58° FOV: W stays on body-forward while the ladder reads the biased camera and FPV follows ground velocity.",
    player: { headingDeg: 0, pitchDeg: 0, bankDeg: 0, altFt: 400 },
    bandit: { azimuthDeg: 0, elevationDeg: -8, rangeM: 500 },
    lead: null,
    cameraFovDeg: 58,
    ladderReference: "camera",
    view: { lookYawDeg: 0, lookPitchDeg: 4.6 },
    state: {
  ...
  },
  {
    ...
    about: "Pitched/banked Cobra regression: body W must separate from the world-horizon 0 rung instead of disappearing into it.",
    player: { headingDeg: 20, pitchDeg: 20, bankDeg: 35, altFt: 400 },
    bandit: { azimuthDeg: 0, elevationDeg: -8, rangeM: 500 },
    lead: null,
    cameraFovDeg: 58,
    ladderReference: "camera",
