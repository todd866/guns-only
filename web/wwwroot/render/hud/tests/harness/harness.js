...
window.__debugScenario = async (name) => {
  ...
  return {
    ...
    state: {
      ...
      opponent_alive: frame.state.opponent_alive,
      ...
      rtb_bearing_deg: frame.state.rtb_bearing_deg,
      rtb_steer: frame.state.rtb_steer,
      rtb_closure_kts: frame.state.rtb_closure_kts,
      fuel_lb: frame.state.fuel_lb,
      fuel_flow_pph: frame.state.fuel_flow_pph,
