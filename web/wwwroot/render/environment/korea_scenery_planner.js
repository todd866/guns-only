...
export const KOREA_SCENERY_PROFILES = Object.freeze({
  ...
  "ukraine-modern": Object.freeze({
    ...
    // Desktop Ukraine bar: denser Place-scale structure — still not a village carpet.
    treeDensityPerKm2: 78,
    buildingDensityPerKm2: 2.2,
    ...
    treeLimitScale: 0.68,
    buildingLimitScale: 0.62,
    fieldLimitScale: 0,
    settlementClusters: 7,
    settlementSpread01: 0.036,
    woodlandClusters: 8,
    woodlandSpread01: 0.14,
    woodlandClusterShare: 0.82,
    shelterbeltBands: 2,
    shelterbeltRowChance: 0.68,
    shelterbeltColumnChance: 0.52,
    shelterbeltSpacingM: 90,
    ...
    grassPatchDensityPerKm2: 260,
    grassPatchLimitScale: 1.15,
    grassHeightM: [0.5, 1.25],
    grassRadiusM: [4, 10],
    localGrassRadiusM: 340,
    localGrassSnapM: 38,
    localGrassUpdatesPerFrame: 220,
    // Keep camera-local meadow alive through low-level punch-outs (~1000 ft), not only nap-of-earth.
    localGrassMaximumCameraAltitudeM: 380,
