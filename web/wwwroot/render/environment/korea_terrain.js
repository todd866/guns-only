...
void main() {
  ...
  float waterFacing = clamp(dot(normal, viewDirection), 0.0, 1.0);
  ...
  vec3 waterHalf = normalize(viewDirection + normalize(uSunDirection));
  ...
  vec3 hazeColor = mix(uFogColor, vec3(0.36, 0.52, 0.68), uModernScenery);
