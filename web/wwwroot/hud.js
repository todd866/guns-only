...
class CombatHud {
  ...
  drawVerticalTape({ value, x, step, decimals = 0, suffix = "", floor = null, trend = 0 }) {
    const ctx = this.ctx;
  ...
  drawLegend() {
    ...
    const wideLines = [
      ...
      "1–5  MISSION   ·   C  AXIAL / ANGLED DECK   ·   R  RESTART   ·   F1  VARIANT   ·   H  HIDE",
    ];
    const compactLines = [
      ...
      "C  AXIAL / ANGLED DECK   ·   R  RESTART   ·   F1  VARIANT   ·   H  HIDE",
    ];
