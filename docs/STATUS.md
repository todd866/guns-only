...
Next candidate: Build 290 (branch `fix/ember-run-pass2`) — overnight pass 16: ambient caps filled on mobile/balanced; softer gorge occlusion; tighter paddy parcels; exposure 1.14.
