...
Updated: 2026-09-10
Production: Build 358, revision `da061df80d72e4ddf1cb709af85f949e80f9a8e5`.
Next candidate: Build 359, not deployed — corrects Fire Boss elevator/trim, surface-to-flight continuity, drag and cockpit coordinates; plans feasible water loads and repairs fuel-return and Apex escape guidance. Independent response checks, actual browser input evidence and full route regressions have distinct acceptance scopes. See [Fire Boss handling audit](audits/2026-09-10-fireboss-handling.md).
...
Production: Build 358, revision `da061df80d72e4ddf1cb709af85f949e80f9a8e5`. Builds 343 (Soniachne first-visit on-ramp), 347 (shared
...
- Live production is Build 358, revision `da061df80d72e4ddf1cb709af85f949e80f9a8e5`. Local gate
