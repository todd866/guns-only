...
Updated: 2026-08-10
Production: Build 306, revision `d28c9bb1b7104f9a4b8b5ebdb23e86788e449807`, deployment
`dpl_HSF4CG3RdxyeMSpmntV2vZMPAGUm` (verified live via /api/build-info 2026-08-10). Builds
253-298 shipped without this ledger always being updated in lock-step; treat per-build claims in
that range with care.
Next candidate: Build 307 (branch `fix/cobra-yaw-wind-telem`) — hover residual + cruise
weathervane, canyon terrain wind, yaw/wind SCAS audit telemetry.
...
| Cobra Canyon (`cobra-lab`, `/cobra-lab/`) | **production** | Standalone route | Hold the Bridge / Ember Run: AH-1G, sim-owned ground war, tip/hold win/lose, M134 + Camp Ember rearm, Tab/F gunner. Build 301: land spur Camp Ember FOB, airborne soft gates, denser Iron Bell destroyables. Build 306: limited SCAS only. Build 307 candidate: stronger hover TQ residual, cruise weathervane, terrain wind + yaw/wind telem | Owner verify hover needs left pedal, cruise holds better, gorge wind visible in traces. Longer arc: DCS-BS1-grade flight dynamics |
...
- Live production is Build 306 (`d28c9bb1b7104f9a4b8b5ebdb23e86788e449807`, `dpl_HSF4CG3RdxyeMSpmntV2vZMPAGUm`).
  Do not treat the smoke gate as a frame-rate measurement.
