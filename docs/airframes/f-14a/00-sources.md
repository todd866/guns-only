...
| Sweep-dependent aerodynamic polar | Forward: CLmax 1.55, CLalpha 5.2/rad, induced K 0.040, Mcrit 0.80; aft: CLmax 1.24, CLalpha 4.05/rad, induced K 0.066, Mcrit 0.98; aft roll inertia 58,000 kg·m² with increased roll-control and rate-damping coefficients; continuous interpolation by published span endpoints | provisional reduced-order surrogate | Makes the variable geometry physically consequential: forward rewards low-speed lift/turning, aft reduces the transonic penalty, and the inward mass/control schedule prevents sloppy swept-wing roll response. These are transparent gameplay coefficients, not OEM data. |
| Approach-flap lift increment | +0.50 CLmax, duplicated in the F-14 systems profile and Top Gun recovery setup | provisional carrier-recovery surrogate | Adds the shared carrier-jet flap increment to the forward-sweep CLmax (1.55 → 2.05) so the computed on-speed cue and physical touchdown remain inside the authored Case I recovery card at mission fuel weights. It is a deterministic gameplay fit, not an F-14 flap measurement. Clean-wing `+0.00` was rejected because it forces an implausibly fast groove in this reduced-order polar; borrowing a Panther-specific derivation was rejected because that airframe and its 114 kt source do not establish Tomcat lift. Replace when an open F-14 approach polar or lift-increment source is available. |
| Transonic drag peak | M1.15; quadratic rise is held above the peak, with a separate gentle high-Mach rise from M2.05 | provisional reduced-order surrogate | The previous unbounded transonic quadratic manufactured an M1.1 wall at both 12,000 ft and FL340. A transonic rise cannot remain an ever-growing supersonic drag law. |
