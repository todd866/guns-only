...
| Reduced-order shaft-power rise constant | 0.12 s | provisional control-response fit used by `Ah1gCobraDefinition`. The manual's “up to four seconds” bottom-to-full turbine lag implies 1.33 s for a literal first-order engine spool, but that alternative was rejected here because this state also stands in for governor/fuel-control anticipation after the engine is already governed: it produced a large, delayed Nr collapse on ordinary collective pickup. The model still preserves finite rotor inertia, torque demand, a 0.40 s power-fall lag and visible transient Nr sag. Replace with separate gas-generator, power-turbine and governor states when transient data are available. |
...
| Forward-flight weathervane yaw response | 15–35 m/s smoothstep; 1.55 /s velocity-alignment gain; 36°/s cap; existing μ/0.18 × 2.4 /s yaw-rate damping | provisional, owner-observation calibration (2026-08-15), not a measured derivative. The schedule leaves hover pedal authority intact, becomes material through translational flight, and makes a low-energy stall turn possible without snapping the nose. Zero alignment was rejected because the aircraft would slide sideways indefinitely; immediate/full alignment was rejected because it erased pedal sideslip and felt like heading autopilot. Replace with separated fin, fuselage and tail-rotor derivatives against open flight-test data. |
