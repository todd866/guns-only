...
| Lean-stabilization gain scheduling | Bar correction scaled by `G_ref/G(v)` above 60 km/h, where `G(v) = maxBar·v²/(L_eff·g)` is the steer-to-lean plant gain | Keeps the closed lean loop speed-invariant; the fixed-gain correction plus the 3.0 units/s steer rate limit formed a limit-cycle oscillator (sustained 150+ km/h weave, per-cycle amplitude ratio 1.5–1.7) | Straight-line weave probe: assisted per-cycle amplitude ratio < 0.5 at 60/100/150/200/250 km/h; raw non-growing |
